...
all() ->
    ...
    {<<"Delusions of Victory">>,
     <<"Declare a false Ron and pay a chombo penalty for it">>,<<"noimg.png">>},
    {<<"Die Hard">>,
    ...
    {<<"Four o' Four">>,<<"Force an abortive draw by calling the fourth Kan">>,
     <<"noimg.png">>},
    {<<"God Called on the Phone">>,<<"Score a God's Hand">>,<<"noimg.png">>},
    {<<"Grenadier">>,
    ...
    {<<"I Have an Encoding Problem!">>,
     ...
     <<"noimg.png">>},
    {<<"I Run an Orphanage">>,
     <<"Score a Thirteen Orphans on a thirteen-sided wait">>,<<"noimg.png">>},
    {<<"I'll Do It Myself!">>,
    ...
    {<<"King of the Mountain">>,
     ...
     <<"noimg.png">>},
    {<<"Lack of Presence">>,
     <<"Terminate either a Tonpuusen (East-Only match) or the East hand of an Hanchan (East-South match) wind round without any of your tiles being called">>,
     <<"noimg.png">>},
    ...
    {<<"Nine Etched Fails">>,
     ...
     <<"noimg.png">>},
    {<<"No Pain, No Gain">>,
     <<"Terminate a full game (either East-South or East-only) with a result of +-0 after awarding the winner bomuses">>,
     <<"noimg.png">>},
    {<<"Nuke From Orbit">>,
     <<"Reduce three opponents' points below zero with a single tsumo">>,
     <<"noimg.png">>},
    {<<"O Hai, I'm in Tenpai!">>,<<"Declare a Double Riichi">>,<<"noimg.png">>},
    ...
    {<<"Save the Children From The Bad Guys">>,
     <<"Score a Thirteen Orphans robbing a closed Kan">>,<<"noimg.png">>},
    {<<"Save Tsumonday!">>,<<"Play your first game">>,<<"noimg.png">>},
    {<<"Seventh Son of a Seventh Tile">>,<<"Score a Seven Pairs">>,
     <<"noimg.png">>},
    {<<"Shot on the Crowd">>,
     <<"Reduce an opponent's points below zero with a Tsumo">>,<<"noimg.png">>},
    {<<"Siberian Express">>,
